...
```sh
git clone https://github.com/roniqueh/nvim-config.git "${XDG_CONFIG_HOME:-$HOME/.config}"/nvim
```
...
```
git clone https://github.com/roniqueh/nvim-config.git %userprofile%\AppData\Local\nvim\
```

If you're using `powershell.exe`

```
git clone https://github.com/roniqueh/nvim-config.git $env:USERPROFILE\AppData\Local\nvim\
```
